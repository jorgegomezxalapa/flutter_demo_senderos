...
class ModuloInspeccionState extends State<ModuloInspeccion> {
  ...
  List<DataRow> generateDataRows(List<Map<String, Object?>> inspecciones) {
    return inspecciones.map((inspeccion) {
      String inspeccionId =
          inspeccion[DatabaseHelper.columnInspeccionIdInspeccion].toString();
      int inspeccion_id = int.parse(inspeccionId);
      var fecha_inspeccion =
          inspeccion[DatabaseHelper.columnInFecInspeccionInspeccion].toString();
      var nombre_razon_social =
          inspeccion[DatabaseHelper.columnInCtRazonSocialInspeccion].toString();
      var domicilio =
          inspeccion[DatabaseHelper.columnInDomicilioInspeccionInspeccion]
              .toString();
      String subtipoActuacionId =
          inspeccion[DatabaseHelper.columnSubtipoInspeccionIdInspeccion]
              .toString();
      ...
      String materiaId =
          inspeccion[DatabaseHelper.columnMateriaIdInspeccion].toString();
                        ...
                        child: DataTableTheme(
                          data: DataTableThemeData(
                            headingRowColor:
                              ...
                              return const Color(
                                  0xFFEFEBDD); // Reemplaza el valor con tu color personalizado
                            }),
                            dividerThickness:
                                2.0, // Ajusta el grosor del borde inferior según sea necesario
                          ),
                          child: DataTable(
